 ...
 * @property Subcategoria $fKCATEGORIA
...
class Subcategoria extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('DESCRIPCION, IMAGEN', 'length', 'max'=>1024),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID, NOMBRE, DESCRIPCION, IMAGEN, FK_CATEGORIA', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'fKCATEGORIA' => array(self::BELONGS_TO, 'Subcategoria', 'FK_CATEGORIA'),
			'subcategorias' => array(self::HAS_MANY, 'Subcategoria', 'FK_CATEGORIA'),
		);
	}
